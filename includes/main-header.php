			...
			<div class="items-cart-inner">
				<div class="total-price-basket">
					...
					<span class="total-price">
						...
						<span class="value"><?php echo $_SESSION['tp']; ?> tk</span>
					</span>
				</div>
				<div class="basket">
		 ...
		 <?php
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">BDT -<?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>BDT -<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
				</div>
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">Continue..</a>	
			</div><!-- /.cart-total-->
