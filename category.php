				...
				<div class='col-md-3 sidebar'>
					...
					<div class="side-menu animate-dropdown outer-bottom-xs">       
						...
						<div class="sidebar-module-container">
							<h3 class="section-title">food by</h3>
							<div class="sidebar-filter">
								<!-- ============= SIDEBAR CATEGORY ========= -->
								<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
									<div class="widget-header m-t-20">
										<h4 class="widget-title">Food Category</h4>
									</div>
															...
															<div class="products">				
																<div class="product">		
																	<div class="product-image">
																		<div class="image">
																			<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="260" height="260"></a>
																		</div><!-- /.image -->	   
																	</div><!-- /.product-image -->
																	...
																	<div class="product-info text-left">
																		...
																		<div class="product-price">	
																			<span class="price">
																				BDT <?php echo htmlentities($row['productPrice']);?>			</span>
