										...
										<table class="table table-bordered">
											<thead>
												<tr>
													...
													<th class="cart-sub-total item">Price(BDT)</th>
													<th class="cart-sub-total item">Delivery Charge(BDT)</th>
													<th class="cart-total last-item">Total(BDT)</th>
												</tr>
											</thead><!-- /thead -->
											<tfoot>
												<tr>
													<td colspan="7">
														<div class="shopping-cart-btn">
															<span class="">
																<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continue...</a>
														...
														<tr>
															...
															<td class="cart-image">
																<a class="entry-thumbnail" href="detail.html">
																	<img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" alt="" width="140" height="140">
																</a>
															</td>
															...
															<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo " "." ".$row['productPrice']; ?>.00 tk</span></td>
															<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo " "." ".$row['shippingCharge']; ?>.00 tk</span></td>

															<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00 tk</span></td>
														</tr>
													...
													<td>
														<div class="form-group">
															...
															while($row=mysqli_fetch_array($query))
															{
																...
																<div class="form-group">
																	<label class="info-title" for="Billing Pincode">Food Pincode <span>*</span></label>
												...
												<tr>
													<th>
														...
														<div class="cart-grand-total">
															Grand Total<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00 tk"; ?></span>
														</div>
													</th>
												</tr>
											</thead><!-- /thead -->
